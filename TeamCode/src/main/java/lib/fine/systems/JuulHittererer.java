...
public class JuulHittererer {
    ...
    public void lower() {
        ...
        pivot.setPosition(0.416);
        swingyBoi.setPosition(0.08);//0.07
        juul.setPosition(0.4);
        opMode.sleep(400);
        pivot.setPosition(0.55);// 0.516
        juul.setPosition(0.56);//0.53
