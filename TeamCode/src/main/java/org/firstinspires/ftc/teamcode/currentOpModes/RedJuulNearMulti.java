 ...
 */
@Autonomous(name = "Strawberry Juul Near Multi V4.396")
public class RedJuulNearMulti extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (column == RIGHT) {
            ...
            robot.drive.strafeRange(1010, 0.8);
        }
        ...
        robot.drive.encoderTurn(-angle/2 + 45, 1);
        robot.drive.stop();
